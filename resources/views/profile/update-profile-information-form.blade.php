<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="w-md-75">
            ...
            <!-- Email -->
            <div class="form-group">
                <x-jet-label for="personal_id" value="{{ __('Personal ID') }}" />
                <x-jet-input id="personal_id" type="text" class="{{ $errors->has('personal_id') ? 'is-invalid' : '' }}" wire:model.defer="state.personal_id" />
                <x-jet-input-error for="personal_id" />
            </div>
        </div>
    </x-slot>
